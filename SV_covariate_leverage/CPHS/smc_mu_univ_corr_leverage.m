function [particles,w,indx,sir_llh]=smc_mu_univ_corr_leverage(y,phi,tau,mu,rho,beta,z,N,T,u1,u1_res)
   ...
   for t=2:T
       ...
       eps_t=(y(1,t-1)-beta'*z(:,t-1)).*exp(-particles(:,indx(t,1:N),t-1)./2);
