...
for i=1:iter
    ...
    Post.ctrajf4sum=ctrajf4_store;
     ...
     if i==250 | i==500 | i==1000 | i==2000 | i==3000 | i==4000 | i==5000 | i==6000 | i==7000 | i==10000 | i==12000 | i==14000
        save('/srv/scratch/z3512791/factor_SV/corr_factor_real_leverage4factor_N50.mat','Post','llh_store','llh_post');
        %save('corr_factor_real_N100_leverage.mat','Post');
        %save('/short/jz21/dg2271/corr_mix/factor_SV/corr_factor_real_leverage4factor.mat','Post','llh_store','llh_post');
     end
     
end
save('/srv/scratch/z3512791/factor_SV/corr_factor_real_leverage4factor_N50.mat','Post','llh_store','llh_post');
%save('corr_factor_real_N100_leverage.mat','Post');
%save('/short/jz21/dg2271/corr_mix/factor_SV/corr_factor_real_leverage4factor2.mat','Post','llh_store','llh_post');
