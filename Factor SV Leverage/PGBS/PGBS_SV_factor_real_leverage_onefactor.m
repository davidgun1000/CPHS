%parpool(28)
%load the data
load('dataindustrystockreal1000.mat');
dim_y=26; 
num_fact=1;
...
for i=1:iter
        i
    %sampling  factor loadingsin Gibbs step
    for s=1:dim_y
    ...
    %store the results
     if i==250 | i==500 | i==1000 | i==2000 | i==3000 | i==4000 | i==5000 | i==6000 | i==7000 | i==10000 | i==12000 | i==14000
        ...
        %save('/short/jz21/dg2271/corr_mix/factor_SV/PG_real_N100_leverage.mat','Post');
        %save('/short/jz21/dg2271/corr_mix/PG_T1000/PG_real_N50_leverage.mat','Post');
     end
