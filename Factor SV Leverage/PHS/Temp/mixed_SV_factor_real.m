...
load('dataindustrystockreal.mat');
dim_y=28;
num_fact=1;
...
parfor s=1:dim_y
  [X,W,A,~]=smc_mu_factorSV(y(s,:),B(s,:),fact_score,phi(s,1),tau(s,1),mu(s,1),N,T,s,dim_y);
...
%     end
    ...
    Post.ctraj28(i,:)=ctraj(28,id);
     ...
     if i==250 | i==500 | i==1000 | i==2000 | i==3000 | i==4000 | i==5000 | i==6000 | i==7000 | i==10000 | i==12000 | i==14000
        save('/short/jz21/dg2271/corr_mix/factor_SV/mix_factor_real_N100.mat','Post');
     end
