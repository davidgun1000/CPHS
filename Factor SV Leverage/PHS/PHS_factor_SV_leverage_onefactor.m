...
dim_y=26; %the dimension of the time series
num_fact=1; %the number of factors
...
for i=1:iter
    ...
    parfor s=dim_y+1:dim_y+num_fact
       ...
       thatasave2(i,s-dim_y)=log(tau(s,1));
    ...
    %save the results    
     if i==250 | i==500 | i==1000 | i==2000 | i==3000 | i==4000 | i==5000 | i==6000 | i==7000 | i==10000 | i==12000 | i==14000
        %save('/short/jz21/dg2271/corr_mix/factor_SV/mix_factor_real_leverage_onefactor_N100.mat','Post');
     end
